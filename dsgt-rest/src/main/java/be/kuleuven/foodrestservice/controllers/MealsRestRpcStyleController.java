...
public class MealsRestRpcStyleController {
    ...
    @GetMapping("/restrpc/meals/healthiest")
    Meal getHealthiestMeal() {
        return mealsRepository.getHealthiestMeal();
    }
